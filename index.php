...
<div class="container">
	...
	<i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:Thelaundry@Gmail.com">azizfatkhu@gmail.com</a>
	</div>
	<div class="col-md-6 w3_c">
	<i class="fa fa-phone" aria-hidden="true"></i> +6285800613959
	</div>
	<div class="col-md-3 w3_r">
	<a href="https://facebook.com/afatkhu" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
	<a href="https://www.instagram.com/azzftkhuwwwww" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
	<a href="https://twitter.com/azizfatkhu" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
	</div>
...
<nav class="navbar navbar-default ">
  <div class="container">
    ...
    <div class="navbar-header">
     ...
     <h1><a class="navbar-brand" href="#">Azhary Fast Dry</a></h1>
    </div>
...
<div class="w3l_bandwn">
 <h2>Welcome to Azhary FastDry</h2>
...
<a href="#" data-toggle="modal" data-target="#myModal">Read More </a>
  <div class="modal video-modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModal">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ahary FastDry</h4>
        </div>
		...
		<div class="container">
			<div class="agile-contact-grids">
			     <h3>Contact</h3>
					...
					<div class="map-grid">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d6962.796130682321!2d110.37614523869696!3d-7.646836164261073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sid!4v1710132660649!5m2!1sen!2sid" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		...
		<div class="container">
			<div class="list">
				...
				<div class="col-md-6 wthree_fc">
					...
					<h6>+6285800613959</h6>
					<h6><a href="mailto:service@decorate.com">azizfatkhu@gmail.com</a></h6>
					</div>
			</div>
		</div>
	</div>
...
<div class="copyright">
		<div class="container">
			<p>© <?php echo date('Y');?> Azhary Fastdry. All rights reserved | Design by <a href="">Aziz Fatkhu</a>
		</div>
</div>
